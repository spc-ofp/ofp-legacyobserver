...
public class GearRepository extends Repository<Gear> implements IGearRepository {
    ...
    private static final String SELECT_QUERY =
		...
		"    OBSTRIP_ID, " + 
		"    MLINE_HAUL, " + 
		"    trim(C_MLINE_HA) as C_MLINE_HA, " + 
		"    trim(BLINE_HAUL) as BLINE_HAUL, " + 
		"    trim(C_BLINE_HA) as C_BLINE_HA, " + 
		...
		"    trim(C_BRANCH_A) as C_BRANCH_A, " + 
		"    trim(WEIGHT_SCA) as WEIGHT_SCA, " + 
		"    trim(C_WEIGHT_S) as C_WEIGHT_S, " + 
    ...
    private static final class GearMapper implements RowMapper<Gear> {
        ...
        public Gear mapRow(final ResultSet rs, final int rowNum) throws SQLException {
			...
			obj.setC_mline_ha(rs.getString("C_MLINE_HA")); //rs.getString("C_MLINE_HA");
			obj.setBline_haul(rs.getString("BLINE_HAUL")); //rs.getString("BLINE_HAUL");
			obj.setC_bline_ha(rs.getString("C_BLINE_HA")); //rs.getString("C_BLINE_HA");
			...
			obj.setC_branch_a(rs.getString("C_BRANCH_A")); //rs.getString("C_BRANCH_A");
			obj.setWeight_sca(rs.getString("WEIGHT_SCA")); //rs.getString("WEIGHT_SCA");
			obj.setC_weight_s(rs.getString("C_WEIGHT_S")); //rs.getString("C_WEIGHT_S");
			...
			obj.setBlast_free(rs.getString("BLAST_FREE")); //rs.getString("BLAST_FREE");
			obj.setIce(rs.getString("ICE")); //rs.getString("ICE");
			obj.setChilled_se(rs.getString("CHILLED_SE")); //rs.getString("CHILLED_SE");
			obj.setOth_storag(rs.getString("OTH_STORAG")); //rs.getString("OTH_STORAG");
			...
			obj.setHk_circle_(rs.getString("HK_CIRCLE_")); //rs.getString("HK_CIRCLE_");
			obj.setHk_circle2(readInteger(rs, "HK_CIRCLE2")); //readInteger(rs, "HK_CIRCLE2");
