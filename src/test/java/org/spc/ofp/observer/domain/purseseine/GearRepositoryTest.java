...
public class GearRepositoryTest {
	...
	private static final long TRIP_ID = 8330L;
	
	/**
	 * Test method for {@link org.spc.ofp.observer.domain.purseseine.GearRepository#findByTripId(long)}.
	 */
	@Test
	@Ignore("s_gear hasn't been migrated yet")
